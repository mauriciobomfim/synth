...
class NG4JAdapter < ActiveRDF::ActiveRdfAdapter

  ActiveRDF::ConnectionPool.register_adapter(:ng4j, self)
  ...
  def build_object(object)
    if object.respond_to? :uri
      ...
      if objlit.datatype
        ...
        o = Jena::Graph::Node.createLiteral(objlit, nil, type)
      elsif objlit.language
        o = Jena::Graph::Node.createLiteral(objlit, objlit.language, nil)
      else
        o = Jena::Graph::Node.createLiteral(objlit)
      end
    end
    return o
  end
