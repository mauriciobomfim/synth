...
module ActiveRDF
  class Namespace
    ...
    def Namespace.register(prefix, fullURI)
      ...
      ns.prefix = prefix
      begin
        ActiveRDF::FederationManager.set_namespace(prefix, fullURI)
      rescue
      end
    ...
    def Namespace.remove(prefix)
      @@inverted_namespaces.delete(@@namespaces[prefix])
      @@namespaces.delete(prefix)
      begin
        ActiveRDF::FederationManager.remove_namespace(prefix)
      rescue
      end
    end
