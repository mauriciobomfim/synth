...
module ActiveRDF
  ...
  #  end
    ...
    def load(file)
      ...
      @db.add(reader, "", RDFFormat::RDFXML)
      @db
    end
    ...
    def execute(query)
      ...
      #tuplequeryresult = @db.evaluateTupleQuery(QueryLanguage::SPARQL, qs) #Mauricio: era assim
      ...
      #solutionIterator = tuplequeryresult.iterator#Mauricio: era assim
      solutionIterator = tuplequeryresult
      ...
      tuplequeryresult.close() #Mauricio: isso é novo
      return results
    end
